...
def test_report_button_available(setup):
    '''Test Case: Validate the Report button existance '''
...
def test_view_report_button_available(setup):
    '''Test Case: Validate the View Report button '''
    report = ReportPanel(setup)
...
def test_download_current_html_flow(setup):
    '''Test Case: Validate the Download Current HTML Report button flow'''
    report = ReportPanel(setup)
...
def test_download_current_bsut_flow(setup):
    '''Test Case: Validate the Download Current BSUT Report Data button flow'''
    report = ReportPanel(setup)
